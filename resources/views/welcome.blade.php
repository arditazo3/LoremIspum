...
<head>
    ...
    <meta name="description" content="WEBAPP.AL">
    <meta name="author" content="WEBAPP.AL">

    <title>WEBAPP.AL - Landing Page</title>
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a class="page-scroll" href="{{  Auth::check() ? url('admin') : url('login')  }}">
